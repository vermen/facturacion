        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td><?php echo $value['categoriaNombre']?></td>
              <td><?php echo $value['descripcion']?></td>
              <td><?php echo $value['imagen']?></td>
              <td>
                <a class="btn btn-danger" href="borrarFactura.php?id=<?=$value['categoriaID']?>&req=delete">Borrar</a>
                <a class="btn btn-warning" href="editarFactura.php?id=<?=$value['categoriaID']?>">Editar</a>
              </td>
            </tr>
            <?php }?>
          </tbody>
